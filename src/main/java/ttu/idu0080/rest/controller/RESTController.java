...
public class RESTController {
	...
	public @ResponseBody Car insertCar(@RequestBody Car car)
	{
	...
	public @ResponseBody void deleteCar(@PathVariable int id) throws IOException{

		dataService.delete(id);
		// TODO: what is the best response here (204 - how to do this in Java)?
		return;
	}
	
	// service/car/search/' + search_make
	@RequestMapping(value="/service/car/search/{make}",method = RequestMethod.GET, produces = "application/json")
	public @ResponseBody List<Car> searchCarByMake(@PathVariable String make) throws IOException{
		
		List<Car> cars = dataService.searchByModel(make);
		return cars;
	}
}
